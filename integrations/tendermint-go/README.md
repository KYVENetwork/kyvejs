# Tendermint-Go Runtime Server

This is the Tendermint-Go runtime server.
...
The REST server with your testdata is reachable under `http://kyve-e2e-test-testapi-integration-tendermint-go:8080`
</details>

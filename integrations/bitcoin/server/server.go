...
import (
	...
	pb "github.com/KYVENetwork/kyvejs/integrations/bitcoin/proto/kyverdk/runtime/v1"
	"github.com/KYVENetwork/kyvejs/integrations/bitcoin/utils"
...
type BitcoinItemValue struct {
	// TODO: Define data properties here
	// Example:
	Block string `json:"block"`
}

type BitcoinTransformedItemValue struct {
	// TODO: Define data properties here
	// Example:
	Block string `json:"block"`
}
...
func (t *BitcoinServer) GetRuntimeName(ctx context.Context, req *pb.GetRuntimeNameRequest) (*pb.GetRuntimeNameResponse, error) {
	return &pb.GetRuntimeNameResponse{Name: "@kyvejs/bitcoin"}, nil
}

// GetRuntimeVersion returns the version of the runtime. Example "1.2.0"
func (t *BitcoinServer) GetRuntimeVersion(ctx context.Context, req *pb.GetRuntimeVersionRequest) (*pb.GetRuntimeVersionResponse, error) {
...
func (t *BitcoinServer) ValidateSetConfig(ctx context.Context, req *pb.ValidateSetConfigRequest) (*pb.ValidateSetConfigResponse, error) {
...
//
// Deterministic behavior is required
func (t *BitcoinServer) GetDataItem(ctx context.Context, req *pb.GetDataItemRequest) (*pb.GetDataItemResponse, error) {
	var config Config
	...
	//var value = map[string]BitcoinItemValue{}
...
//
// Deterministic behavior is required
func (t *BitcoinServer) PrevalidateDataItem(ctx context.Context, req *pb.PrevalidateDataItemRequest) (*pb.PrevalidateDataItemResponse, error) {
	...
	var itemValue BitcoinItemValue
...
//
// Deterministic behavior is required
func (t *BitcoinServer) TransformDataItem(ctx context.Context, req *pb.TransformDataItemRequest) (*pb.TransformDataItemResponse, error) {
	var itemValue BitcoinItemValue
	err := json.Unmarshal([]byte(req.GetDataItem().GetValue()), &itemValue)
	if err != nil {
		return nil, status.Errorf(codes.Internal, "Error unmarshalling data item: %v", err)
...
//
// Deterministic behavior is required
func (t *BitcoinServer) ValidateDataItem(ctx context.Context, req *pb.ValidateDataItemRequest) (*pb.ValidateDataItemResponse, error) {
	requestProposedDataItem := req.GetProposedDataItem()
	requestValidationDataItem := req.GetValidationDataItem()

	var proposed BitcoinTransformedItemValue
	var validation BitcoinTransformedItemValue
...
//
// Deterministic behavior is required
func (t *BitcoinServer) NextKey(ctx context.Context, req *pb.NextKeyRequest) (*pb.NextKeyResponse, error) {
	key := req.GetKey()

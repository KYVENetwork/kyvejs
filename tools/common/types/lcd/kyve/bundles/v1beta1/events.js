...
function createBaseEventBundleVote() {
  return {
    ...
    staker: "",
    storage_id: "",
    vote: tx_1.VoteType.VOTE_TYPE_UNSPECIFIED,
  };
}
exports.EventBundleVote = {
  encode: function (message, writer) {
  ...
  fromJSON: function (object) {
    return {
      ...
      vote: isSet(object.vote)
        ? (0, tx_1.voteTypeFromJSON)(object.vote)
        : tx_1.VoteType.VOTE_TYPE_UNSPECIFIED,
    };
  },
  toJSON: function (message) {
    var obj = {};
...
exports.EventBundleFinalized = {
  encode: function (message, writer) {
    ...
    if (message.status !== bundles_1.BundleStatus.BUNDLE_STATUS_UNSPECIFIED) {
      writer
        .uint32(56)
        .int32((0, bundles_1.bundleStatusToNumber)(message.status));
    }
  ...
  fromJSON: function (object) {
    return {
      ...
      status: isSet(object.status)
        ...
        : bundles_1.BundleStatus.BUNDLE_STATUS_UNSPECIFIED,
  ...
  fromPartial: function (object) {
    ...
    message.status =
      (_g = object.status) !== null && _g !== void 0
        ? _g
        : bundles_1.BundleStatus.BUNDLE_STATUS_UNSPECIFIED;

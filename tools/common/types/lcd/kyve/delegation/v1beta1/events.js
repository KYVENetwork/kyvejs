...
function createBaseEventSlash() {
  return {
    ...
    staker: "",
    amount: "0",
    slash_type: delegation_1.SlashType.SLASH_TYPE_UNSPECIFIED,
  };
}
exports.EventSlash = {
  encode: function (message, writer) {
    ...
    if (message.slash_type !== delegation_1.SlashType.SLASH_TYPE_UNSPECIFIED) {
      writer
        .uint32(32)
        .int32((0, delegation_1.slashTypeToNumber)(message.slash_type));
    }
    return writer;
  },
  decode: function (input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.slash_type = (0, delegation_1.slashTypeFromJSON)(
            reader.int32()
          );
          continue;
      }
  ...
  fromJSON: function (object) {
    return {
      ...
      slash_type: isSet(object.slash_type)
        ...
        : delegation_1.SlashType.SLASH_TYPE_UNSPECIFIED,
    };
  },
  toJSON: function (message) {
    var obj = {};
  ...
  fromPartial: function (object) {
    ...
    message.amount = (_c = object.amount) !== null && _c !== void 0 ? _c : "0";
    message.slash_type =
      (_d = object.slash_type) !== null && _d !== void 0
        ? _d
        : delegation_1.SlashType.SLASH_TYPE_UNSPECIFIED;
    return message;
  },

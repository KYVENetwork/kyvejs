...
export declare const PageRequest: {
  ...
  create<
    I extends {
      ...
      count_total?: boolean | undefined;
      reverse?: boolean | undefined;
    } & { [K in Exclude<keyof I, keyof PageRequest>]: never }
  >(
    base?: I | undefined
  ): PageRequest;
  fromPartial<
    I_1 extends {
      ...
      count_total?: boolean | undefined;
      reverse?: boolean | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof PageRequest>]: never }
  >(
    object: I_1
  ): PageRequest;
};
export declare const PageResponse: {
  ...
  create<
    I extends {
      ...
      next_key?: Uint8Array | undefined;
      total?: string | undefined;
    } & { [K in Exclude<keyof I, keyof PageResponse>]: never }
  >(
    base?: I | undefined
  ): PageResponse;
  fromPartial<
    I_1 extends {
      ...
      next_key?: Uint8Array | undefined;
      total?: string | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof PageResponse>]: never }
  >(
    object: I_1
  ): PageResponse;
};

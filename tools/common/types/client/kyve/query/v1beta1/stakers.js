...
exports.QueryStakersClientImpl =
  exports.QueryStakersServiceName =
  ...
  exports.stakerStatusToJSON =
  exports.stakerStatusFromJSON =
  exports.StakerStatus =
...
(function (StakerStatus) {
  ...
  StakerStatus[(StakerStatus["STAKER_STATUS_UNSPECIFIED"] = 0)] =
    "STAKER_STATUS_UNSPECIFIED";
  /** STAKER_STATUS_ACTIVE - STAKER_STATUS_ACTIVE ... */
  StakerStatus[(StakerStatus["STAKER_STATUS_ACTIVE"] = 1)] =
    "STAKER_STATUS_ACTIVE";
  /** STAKER_STATUS_INACTIVE - STAKER_STATUS_INACTIVE ... */
  StakerStatus[(StakerStatus["STAKER_STATUS_INACTIVE"] = 2)] =
...
exports.QueryStakersRequest = {
  ...
  create: function (base) {
    return exports.QueryStakersRequest.fromPartial(
...
exports.QueryStakersResponse = {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.stakers.push(
            query_1.FullStaker.decode(reader, reader.uint32())
          );
          continue;
        case 2:
          if (tag !== 18) {
    ...
    return {
      stakers: globalThis.Array.isArray(
        ...
        ? object.stakers.map(function (e) {
            return query_1.FullStaker.fromJSON(e);
          })
        : [],
      pagination: isSet(object.pagination)
  ...
  toJSON: function (message) {
    ...
    if ((_a = message.stakers) === null || _a === void 0 ? void 0 : _a.length) {
      obj.stakers = message.stakers.map(function (e) {
        return query_1.FullStaker.toJSON(e);
      });
    }
    if (message.pagination !== undefined) {
  ...
  create: function (base) {
    return exports.QueryStakersResponse.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
    ...
    var message = createBaseQueryStakersResponse();
    message.stakers =
      ((_a = object.stakers) === null || _a === void 0
        ? void 0
        : _a.map(function (e) {
            return query_1.FullStaker.fromPartial(e);
          })) || [];
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
...
exports.QueryStakerRequest = {
  ...
  create: function (base) {
    return exports.QueryStakerRequest.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
...
exports.QueryStakerResponse = {
  ...
  create: function (base) {
    return exports.QueryStakerResponse.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
...
exports.QueryStakersByPoolRequest = {
  ...
  create: function (base) {
    return exports.QueryStakersByPoolRequest.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
...
exports.QueryStakersByPoolResponse = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.stakers.push(
            exports.StakerPoolResponse.decode(reader, reader.uint32())
          );
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON: function (object) {
    return {
      stakers: globalThis.Array.isArray(
        ...
        ? object.stakers.map(function (e) {
            return exports.StakerPoolResponse.fromJSON(e);
          })
        : [],
    };
  },
  toJSON: function (message) {
    ...
    if ((_a = message.stakers) === null || _a === void 0 ? void 0 : _a.length) {
      obj.stakers = message.stakers.map(function (e) {
        return exports.StakerPoolResponse.toJSON(e);
      });
    }
    return obj;
  },
  create: function (base) {
    return exports.QueryStakersByPoolResponse.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
    ...
    message.stakers =
      ((_a = object.stakers) === null || _a === void 0
        ? void 0
        : _a.map(function (e) {
            return exports.StakerPoolResponse.fromPartial(e);
          })) || [];
    return message;
  },
};
...
exports.StakerPoolResponse = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.valaccount = stakers_1.Valaccount.decode(
            reader,
            reader.uint32()
          );
          continue;
  ...
  fromJSON: function (object) {
    return {
      ...
      valaccount: isSet(object.valaccount)
        ? stakers_1.Valaccount.fromJSON(object.valaccount)
        : undefined,
    };
  },
  toJSON: function (message) {
  ...
  create: function (base) {
    return exports.StakerPoolResponse.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
...
exports.QueryStakersByPoolCountRequest = {
  ...
  create: function (base) {
    return exports.QueryStakersByPoolCountRequest.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
...
exports.QueryStakersByPoolCountResponse = {
  ...
  create: function (base) {
    return exports.QueryStakersByPoolCountResponse.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
...
var QueryStakersClientImpl = /** @class */ (function () {
  ...
  QueryStakersClientImpl.prototype.Stakers = function (request) {
    ...
    return promise.then(function (data) {
      return exports.QueryStakersResponse.decode(
  ...
  QueryStakersClientImpl.prototype.Staker = function (request) {
    ...
    return promise.then(function (data) {
      return exports.QueryStakerResponse.decode(
        minimal_1.default.Reader.create(data)
      );
    });
  };
  QueryStakersClientImpl.prototype.StakersByPool = function (request) {
    ...
    return promise.then(function (data) {
      return exports.QueryStakersByPoolResponse.decode(
        minimal_1.default.Reader.create(data)
      );
    });
  };
  QueryStakersClientImpl.prototype.StakersByPoolCount = function (request) {
    ...
    return promise.then(function (data) {
      return exports.QueryStakersByPoolCountResponse.decode(
        minimal_1.default.Reader.create(data)
      );
    });
  };

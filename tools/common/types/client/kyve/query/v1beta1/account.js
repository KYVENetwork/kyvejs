...
exports.QueryAccountClientImpl =
  exports.QueryAccountServiceName =
...
exports.QueryAccountAssetsRequest = {
  ...
  create: function (base) {
    return exports.QueryAccountAssetsRequest.fromPartial(
...
exports.QueryAccountAssetsResponse = {
  ...
  fromJSON: function (object) {
    return {
      ...
      protocol_delegation: isSet(object.protocol_delegation)
        ? globalThis.String(object.protocol_delegation)
        : "0",
      ...
      protocol_rewards: isSet(object.protocol_rewards)
        ? globalThis.String(object.protocol_rewards)
        : "0",
      protocol_funding: isSet(object.protocol_funding)
        ? globalThis.String(object.protocol_funding)
        : "0",
    };
  },
  toJSON: function (message) {
  ...
  create: function (base) {
    return exports.QueryAccountAssetsResponse.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
    ...
    var message = createBaseQueryAccountAssetsResponse();
    message.balance =
      (_a = object.balance) !== null && _a !== void 0 ? _a : "0";
    message.protocol_self_delegation =
      (_b = object.protocol_self_delegation) !== null && _b !== void 0
        ? _b
        : "0";
    message.protocol_self_delegation_unbonding =
      (_c = object.protocol_self_delegation_unbonding) !== null && _c !== void 0
        ? _c
        : "0";
    message.protocol_delegation =
      (_d = object.protocol_delegation) !== null && _d !== void 0 ? _d : "0";
    message.protocol_delegation_unbonding =
      (_e = object.protocol_delegation_unbonding) !== null && _e !== void 0
        ? _e
        : "0";
    message.protocol_rewards =
      (_f = object.protocol_rewards) !== null && _f !== void 0 ? _f : "0";
    message.protocol_funding =
      (_g = object.protocol_funding) !== null && _g !== void 0 ? _g : "0";
    return message;
  },
};
...
exports.QueryAccountDelegationUnbondingsRequest = {
  ...
  create: function (base) {
    return exports.QueryAccountDelegationUnbondingsRequest.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
...
exports.QueryAccountDelegationUnbondingsResponse = {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.unbondings.push(
            exports.DelegationUnbonding.decode(reader, reader.uint32())
          );
          continue;
        case 2:
          if (tag !== 18) {
  ...
  fromJSON: function (object) {
    return {
      unbondings: globalThis.Array.isArray(
        object === null || object === void 0 ? void 0 : object.unbondings
      )
        ? object.unbondings.map(function (e) {
            return exports.DelegationUnbonding.fromJSON(e);
          })
        : [],
      pagination: isSet(object.pagination)
  ...
  toJSON: function (message) {
    ...
    var obj = {};
    if (
      (_a = message.unbondings) === null || _a === void 0 ? void 0 : _a.length
    ) {
      obj.unbondings = message.unbondings.map(function (e) {
        return exports.DelegationUnbonding.toJSON(e);
      });
    }
    if (message.pagination !== undefined) {
  ...
  create: function (base) {
    return exports.QueryAccountDelegationUnbondingsResponse.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
    ...
    var message = createBaseQueryAccountDelegationUnbondingsResponse();
    message.unbondings =
      ((_a = object.unbondings) === null || _a === void 0
        ? void 0
        : _a.map(function (e) {
            return exports.DelegationUnbonding.fromPartial(e);
          })) || [];
    message.pagination =
      object.pagination !== undefined && object.pagination !== null
...
exports.DelegationUnbonding = {
  ...
  create: function (base) {
    return exports.DelegationUnbonding.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
    ...
    message.creation_time =
      (_b = object.creation_time) !== null && _b !== void 0 ? _b : "0";
    message.staker =
...
exports.QueryAccountFundedListRequest = {
  ...
  create: function (base) {
    return exports.QueryAccountFundedListRequest.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
...
exports.QueryAccountFundedListResponse = {
  ...
  fromJSON: function (object) {
    return {
      funded: globalThis.Array.isArray(
        object === null || object === void 0 ? void 0 : object.funded
      )
        ? object.funded.map(function (e) {
            return exports.Funded.fromJSON(e);
          })
        : [],
    };
  },
  toJSON: function (message) {
    ...
    if ((_a = message.funded) === null || _a === void 0 ? void 0 : _a.length) {
      obj.funded = message.funded.map(function (e) {
        return exports.Funded.toJSON(e);
      });
    }
    return obj;
  },
  create: function (base) {
    return exports.QueryAccountFundedListResponse.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
    ...
    var message = createBaseQueryAccountFundedListResponse();
    message.funded =
      ((_a = object.funded) === null || _a === void 0
        ? void 0
        : _a.map(function (e) {
            return exports.Funded.fromPartial(e);
          })) || [];
    return message;
  },
};
...
exports.Funded = {
  ...
  fromJSON: function (object) {
    return {
      ...
      pool: isSet(object.pool)
        ? query_1.BasicPool.fromJSON(object.pool)
        : undefined,
    };
  },
  toJSON: function (message) {
  ...
  create: function (base) {
    return exports.Funded.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
    ...
    message.pool =
      object.pool !== undefined && object.pool !== null
        ? query_1.BasicPool.fromPartial(object.pool)
        : undefined;
    return message;
  },
};
...
exports.QueryAccountRedelegationRequest = {
  ...
  create: function (base) {
    return exports.QueryAccountRedelegationRequest.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
...
exports.QueryAccountRedelegationResponse = {
  encode: function (message, writer) {
    ...
    for (
      var _i = 0, _a = message.redelegation_cooldown_entries;
      _i < _a.length;
      _i++
    ) {
      var v = _a[_i];
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.redelegation_cooldown_entries.push(
            exports.RedelegationEntry.decode(reader, reader.uint32())
          );
          continue;
        case 2:
          if (tag !== 16) {
  ...
  fromJSON: function (object) {
    return {
      redelegation_cooldown_entries: globalThis.Array.isArray(
        object === null || object === void 0
          ? void 0
          : object.redelegation_cooldown_entries
      )
        ? object.redelegation_cooldown_entries.map(function (e) {
            return exports.RedelegationEntry.fromJSON(e);
          })
        : [],
      available_slots: isSet(object.available_slots)
        ? globalThis.String(object.available_slots)
        : "0",
    };
  },
  toJSON: function (message) {
    ...
    var obj = {};
    if (
      (_a = message.redelegation_cooldown_entries) === null || _a === void 0
        ? void 0
        : _a.length
    ) {
      obj.redelegation_cooldown_entries =
        message.redelegation_cooldown_entries.map(function (e) {
          return exports.RedelegationEntry.toJSON(e);
        });
    }
    if (message.available_slots !== "0") {
  ...
  create: function (base) {
    return exports.QueryAccountRedelegationResponse.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
    ...
    message.redelegation_cooldown_entries =
      ((_a = object.redelegation_cooldown_entries) === null || _a === void 0
        ? void 0
        : _a.map(function (e) {
            return exports.RedelegationEntry.fromPartial(e);
          })) || [];
    message.available_slots =
      (_b = object.available_slots) !== null && _b !== void 0 ? _b : "0";
    return message;
  },
};
...
exports.RedelegationEntry = {
  ...
  fromJSON: function (object) {
    return {
      creation_date: isSet(object.creation_date)
        ...
        : "0",
      finish_date: isSet(object.finish_date)
        ? globalThis.String(object.finish_date)
        : "0",
    };
  },
  toJSON: function (message) {
  ...
  create: function (base) {
    return exports.RedelegationEntry.fromPartial(
      base !== null && base !== void 0 ? base : {}
    );
  },
  fromPartial: function (object) {
    ...
    message.creation_date =
      (_a = object.creation_date) !== null && _a !== void 0 ? _a : "0";
    message.finish_date =
      (_b = object.finish_date) !== null && _b !== void 0 ? _b : "0";
    return message;
  },
};
...
var QueryAccountClientImpl = /** @class */ (function () {
  ...
  QueryAccountClientImpl.prototype.AccountAssets = function (request) {
    ...
    return promise.then(function (data) {
      return exports.QueryAccountAssetsResponse.decode(
        minimal_1.default.Reader.create(data)
      );
    });
  };
  QueryAccountClientImpl.prototype.AccountDelegationUnbondings = function (
    request
  ) {
    var data =
      exports.QueryAccountDelegationUnbondingsRequest.encode(request).finish();
    ...
    return promise.then(function (data) {
      return exports.QueryAccountDelegationUnbondingsResponse.decode(
        minimal_1.default.Reader.create(data)
      );
    });
  };
  QueryAccountClientImpl.prototype.AccountFundedList = function (request) {
    ...
    return promise.then(function (data) {
      return exports.QueryAccountFundedListResponse.decode(
        minimal_1.default.Reader.create(data)
      );
    });
  };
  QueryAccountClientImpl.prototype.AccountRedelegation = function (request) {
    ...
    return promise.then(function (data) {
      return exports.QueryAccountRedelegationResponse.decode(
        minimal_1.default.Reader.create(data)
      );
    });
  };

    ...
    fromPartial<I extends {
        ...
        signing_infos?: ({
            ...
            validator_signing_info?: ({
                ...
                tombstoned?: boolean | undefined;
                missed_blocks_counter?: string | undefined;
            } & { [K_2 in Exclude<keyof I["signing_infos"][number]["validator_signing_info"], keyof ValidatorSigningInfo>]: never; }) | undefined;
        } & { [K_3 in Exclude<keyof I["signing_infos"][number], keyof SigningInfo>]: never; })[] & { [K_4 in Exclude<keyof I["signing_infos"], keyof {
            address?: string | undefined;
            validator_signing_info?: {
                address?: string | undefined;
                start_height?: string | undefined;
        ...
        missed_blocks?: ({
            ...
            missed_blocks?: ({
                ...
                index?: string | undefined;
                missed?: boolean | undefined;
            } & { [K_5 in Exclude<keyof I["missed_blocks"][number]["missed_blocks"][number], keyof MissedBlock>]: never; })[] & { [K_6 in Exclude<keyof I["missed_blocks"][number]["missed_blocks"], keyof {
                index?: string | undefined;
                missed?: boolean | undefined;
            }[]>]: never; }) | undefined;
        } & { [K_7 in Exclude<keyof I["missed_blocks"][number], keyof ValidatorMissedBlocks>]: never; })[] & { [K_8 in Exclude<keyof I["missed_blocks"], keyof {
            address?: string | undefined;
            missed_blocks?: {
                index?: string | undefined;
                missed?: boolean | undefined;
...
export declare const SigningInfo: {
    ...
    fromPartial<I extends {
        ...
        validator_signing_info?: ({
            ...
            tombstoned?: boolean | undefined;
            missed_blocks_counter?: string | undefined;
        } & { [K in Exclude<keyof I["validator_signing_info"], keyof ValidatorSigningInfo>]: never; }) | undefined;
    } & { [K_1 in Exclude<keyof I, keyof SigningInfo>]: never; }>(object: I): SigningInfo;
};
export declare const ValidatorMissedBlocks: {
    ...
    fromPartial<I extends {
        ...
        missed_blocks?: ({
            ...
            index?: string | undefined;
            missed?: boolean | undefined;
        } & { [K in Exclude<keyof I["missed_blocks"][number], keyof MissedBlock>]: never; })[] & { [K_1 in Exclude<keyof I["missed_blocks"], keyof {
            index?: string | undefined;
            missed?: boolean | undefined;
        }[]>]: never; }) | undefined;
    } & { [K_2 in Exclude<keyof I, keyof ValidatorMissedBlocks>]: never; }>(object: I): ValidatorMissedBlocks;
};
export declare const MissedBlock: {
    ...
    fromPartial<I extends {
        ...
        index?: string | undefined;
        missed?: boolean | undefined;
    } & { [K in Exclude<keyof I, keyof MissedBlock>]: never; }>(object: I): MissedBlock;
};

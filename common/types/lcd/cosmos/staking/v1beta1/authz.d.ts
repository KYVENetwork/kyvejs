...
export declare function authorizationTypeToNumber(object: AuthorizationType): number;
/**
...
export declare const StakeAuthorization: {
    ...
    fromPartial<I extends {
        ...
        max_tokens?: ({
            ...
            denom?: string | undefined;
            amount?: string | undefined;
        } & { [K in Exclude<keyof I["max_tokens"], keyof Coin>]: never; }) | undefined;
        allow_list?: ({
            address?: string[] | undefined;
        } & {
            address?: (string[] & string[] & { [K_1 in Exclude<keyof I["allow_list"]["address"], keyof string[]>]: never; }) | undefined;
        } & { [K_2 in Exclude<keyof I["allow_list"], "address">]: never; }) | undefined;
        deny_list?: ({
            address?: string[] | undefined;
        } & {
            address?: (string[] & string[] & { [K_3 in Exclude<keyof I["deny_list"]["address"], keyof string[]>]: never; }) | undefined;
        } & { [K_4 in Exclude<keyof I["deny_list"], "address">]: never; }) | undefined;
        authorization_type?: AuthorizationType | undefined;
    } & { [K_5 in Exclude<keyof I, keyof StakeAuthorization>]: never; }>(object: I): StakeAuthorization;
};
export declare const StakeAuthorization_Validators: {
    ...
    } & { [K_1 in Exclude<keyof I, "address">]: never; }>(object: I): StakeAuthorization_Validators;
};

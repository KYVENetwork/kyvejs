...
function createBaseQueryProposalsRequest() {
    return {
        proposal_status: gov_1.ProposalStatus.PROPOSAL_STATUS_UNSPECIFIED,
        voter: "",
        depositor: "",
...
exports.QueryProposalsRequest = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        if (message.proposal_status !== gov_1.ProposalStatus.PROPOSAL_STATUS_UNSPECIFIED) {
            writer.uint32(8).int32((0, gov_1.proposalStatusToNumber)(message.proposal_status));
        }
        if (message.voter !== "") {
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.proposal_status = (0, gov_1.proposalStatusFromJSON)(reader.int32());
                    break;
                case 2:
    ...
    fromJSON: function (object) {
        return {
            proposal_status: isSet(object.proposal_status)
                ...
                : gov_1.ProposalStatus.PROPOSAL_STATUS_UNSPECIFIED,
    ...
    fromPartial: function (object) {
        var _a, _b, _c;
        var message = createBaseQueryProposalsRequest();
        message.proposal_status = (_a = object.proposal_status) !== null && _a !== void 0 ? _a : gov_1.ProposalStatus.PROPOSAL_STATUS_UNSPECIFIED;

...
export declare const QueryInflationRequest: {
    ...
    fromPartial<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(_: I): QueryInflationRequest;
};
export declare const QueryInflationResponse: {
    ...
    fromPartial<I extends {
        ...
        inflation?: Uint8Array | undefined;
    } & { [K in Exclude<keyof I, "inflation">]: never; }>(object: I): QueryInflationResponse;
};
export declare const QueryAnnualProvisionsRequest: {
    ...
    fromPartial<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(_: I): QueryAnnualProvisionsRequest;
};
export declare const QueryAnnualProvisionsResponse: {
    ...
    fromPartial<I extends {
        ...
        annual_provisions?: Uint8Array | undefined;
    } & { [K in Exclude<keyof I, "annual_provisions">]: never; }>(object: I): QueryAnnualProvisionsResponse;
};

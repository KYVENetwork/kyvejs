...
function createBaseModeInfo_Single() {
    return { mode: signing_1.SignMode.SIGN_MODE_UNSPECIFIED };
}
exports.ModeInfo_Single = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        if (message.mode !== signing_1.SignMode.SIGN_MODE_UNSPECIFIED) {
            writer.uint32(8).int32((0, signing_1.signModeToNumber)(message.mode));
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.mode = (0, signing_1.signModeFromJSON)(reader.int32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
    ...
    fromJSON: function (object) {
        return { mode: isSet(object.mode) ? (0, signing_1.signModeFromJSON)(object.mode) : signing_1.SignMode.SIGN_MODE_UNSPECIFIED };
    },
    toJSON: function (message) {
        var obj = {};
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseModeInfo_Single();
        message.mode = (_a = object.mode) !== null && _a !== void 0 ? _a : signing_1.SignMode.SIGN_MODE_UNSPECIFIED;
        return message;
    },
};
...
function createBaseAuxSignerData() {
    return { address: "", sign_doc: undefined, mode: signing_1.SignMode.SIGN_MODE_UNSPECIFIED, sig: new Uint8Array() };
}
exports.AuxSignerData = {
    encode: function (message, writer) {
        ...
        if (message.mode !== signing_1.SignMode.SIGN_MODE_UNSPECIFIED) {
            writer.uint32(24).int32((0, signing_1.signModeToNumber)(message.mode));
        }
    ...
    fromJSON: function (object) {
        return {
            ...
            mode: isSet(object.mode) ? (0, signing_1.signModeFromJSON)(object.mode) : signing_1.SignMode.SIGN_MODE_UNSPECIFIED,
    ...
    fromPartial: function (object) {
        ...
        message.sign_doc = (object.sign_doc !== undefined && object.sign_doc !== null)
            ...
            : undefined;
        message.mode = (_b = object.mode) !== null && _b !== void 0 ? _b : signing_1.SignMode.SIGN_MODE_UNSPECIFIED;

...
export declare function proposalResultToNumber(object: ProposalResult): number;
...
export declare function proposalExecutorResultToNumber(object: ProposalExecutorResult): number;
/**
...
export declare const Member: {
    ...
    fromPartial<I extends {
        ...
        metadata?: string | undefined;
        added_at?: Date | undefined;
    } & { [K in Exclude<keyof I, keyof Member>]: never; }>(object: I): Member;
};
export declare const Members: {
    ...
    } & { [K_2 in Exclude<keyof I, "members">]: never; }>(object: I): Members;
};
    ...
    fromPartial<I extends {
        ...
        windows?: ({
            ...
            voting_period?: ({
                ...
                seconds?: string | undefined;
                nanos?: number | undefined;
            } & { [K in Exclude<keyof I["windows"]["voting_period"], keyof Duration>]: never; }) | undefined;
            min_execution_period?: ({
                seconds?: string | undefined;
                nanos?: number | undefined;
            } & {
                seconds?: string | undefined;
                nanos?: number | undefined;
            } & { [K_1 in Exclude<keyof I["windows"]["min_execution_period"], keyof Duration>]: never; }) | undefined;
        } & { [K_2 in Exclude<keyof I["windows"], keyof DecisionPolicyWindows>]: never; }) | undefined;
    } & { [K_3 in Exclude<keyof I, keyof ThresholdDecisionPolicy>]: never; }>(object: I): ThresholdDecisionPolicy;
};
export declare const PercentageDecisionPolicy: {
    ...
    } & { [K_3 in Exclude<keyof I, keyof PercentageDecisionPolicy>]: never; }>(object: I): PercentageDecisionPolicy;
};
export declare const DecisionPolicyWindows: {
    ...
    fromPartial<I extends {
        ...
        min_execution_period?: ({
            ...
            seconds?: string | undefined;
            nanos?: number | undefined;
        } & { [K_1 in Exclude<keyof I["min_execution_period"], keyof Duration>]: never; }) | undefined;
    } & { [K_2 in Exclude<keyof I, keyof DecisionPolicyWindows>]: never; }>(object: I): DecisionPolicyWindows;
};
export declare const GroupInfo: {
    ...
    fromPartial<I extends {
        ...
        total_weight?: string | undefined;
        created_at?: Date | undefined;
    } & { [K in Exclude<keyof I, keyof GroupInfo>]: never; }>(object: I): GroupInfo;
};
export declare const GroupMember: {
    ...
    fromPartial<I extends {
        ...
        member?: ({
            ...
            metadata?: string | undefined;
            added_at?: Date | undefined;
        } & { [K in Exclude<keyof I["member"], keyof Member>]: never; }) | undefined;
    } & { [K_1 in Exclude<keyof I, keyof GroupMember>]: never; }>(object: I): GroupMember;
};
export declare const GroupPolicyInfo: {
    ...
    fromPartial<I extends {
        ...
        created_at?: Date | undefined;
    } & { [K_1 in Exclude<keyof I, keyof GroupPolicyInfo>]: never; }>(object: I): GroupPolicyInfo;
};
export declare const Proposal: {
    ...
    fromPartial<I extends {
        ...
        executor_result?: ProposalExecutorResult | undefined;
        messages?: {
            type_url?: string | undefined;
            value?: Uint8Array | undefined;
        }[] | undefined;
        ...
        final_tally_result?: ({
            ...
            no_count?: string | undefined;
            no_with_veto_count?: string | undefined;
        } & { [K_1 in Exclude<keyof I["final_tally_result"], keyof TallyResult>]: never; }) | undefined;
        voting_period_end?: Date | undefined;
        executor_result?: ProposalExecutorResult | undefined;
        messages?: ({
            type_url?: string | undefined;
    ...
    } & { [K_4 in Exclude<keyof I, keyof Proposal>]: never; }>(object: I): Proposal;
};
...
export declare const Vote: {
    ...
    fromPartial<I extends {
        ...
        metadata?: string | undefined;
        submit_time?: Date | undefined;
    } & { [K in Exclude<keyof I, keyof Vote>]: never; }>(object: I): Vote;
};

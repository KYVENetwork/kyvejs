...
export declare const MsgVerifyInvariant: {
    ...
    fromPartial<I extends {
        ...
        invariant_module_name?: string | undefined;
        invariant_route?: string | undefined;
    } & { [K in Exclude<keyof I, keyof MsgVerifyInvariant>]: never; }>(object: I): MsgVerifyInvariant;
};
export declare const MsgVerifyInvariantResponse: {
    ...
    fromPartial<I extends {} & {} & { [K in Exclude<keyof I, never>]: never; }>(_: I): MsgVerifyInvariantResponse;
};

...
exports.ModuleSchemaDescriptor_FileEntry = exports.ModuleSchemaDescriptor = exports.storageTypeToNumber = exports.storageTypeToJSON = exports.storageTypeFromJSON = exports.StorageType = exports.protobufPackage = void 0;
/* eslint-disable */
...
(function (StorageType) {
     ...
     */
    StorageType["STORAGE_TYPE_DEFAULT_UNSPECIFIED"] = "STORAGE_TYPE_DEFAULT_UNSPECIFIED";
    /**
     ...
     * state from JSON.
     */
    StorageType["STORAGE_TYPE_MEMORY"] = "STORAGE_TYPE_MEMORY";
    /**
     ...
     * state from JSON.
     */
    StorageType["STORAGE_TYPE_TRANSIENT"] = "STORAGE_TYPE_TRANSIENT";
    /**
     ...
     */
    StorageType["STORAGE_TYPE_INDEX"] = "STORAGE_TYPE_INDEX";
    /**
     ...
     */
    StorageType["STORAGE_TYPE_COMMITMENT"] = "STORAGE_TYPE_COMMITMENT";
...
function storageTypeToNumber(object) {
    switch (object) {
        case StorageType.STORAGE_TYPE_DEFAULT_UNSPECIFIED:
            return 0;
        case StorageType.STORAGE_TYPE_MEMORY:
...
exports.storageTypeToNumber = storageTypeToNumber;
...
exports.ModuleSchemaDescriptor_FileEntry = {
    ...
    fromPartial: function (object) {
        ...
        message.storage_type = (_c = object.storage_type) !== null && _c !== void 0 ? _c : StorageType.STORAGE_TYPE_DEFAULT_UNSPECIFIED;
        return message;
    },
};

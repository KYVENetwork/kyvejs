...
exports.FileDescriptorProto = {
    encode: function (message, writer) {
        ...
        for (var _b = 0, _c = message.public_dependency; _b < _c.length; _b++) {
            var v = _c[_b];
            writer.int32(v);
        }
        writer.ldelim();
        writer.uint32(90).fork();
        for (var _d = 0, _e = message.weak_dependency; _d < _e.length; _d++) {
            var v = _e[_d];
            writer.int32(v);
        }
        writer.ldelim();
        for (var _f = 0, _g = message.message_type; _f < _g.length; _f++) {
            var v = _g[_f];
            exports.DescriptorProto.encode(v, writer.uint32(34).fork()).ldelim();
        }
        for (var _h = 0, _j = message.enum_type; _h < _j.length; _h++) {
            var v = _j[_h];
    ...
    fromJSON: function (object) {
        return {
            ...
            public_dependency: Array.isArray(object === null || object === void 0 ? void 0 : object.public_dependency)
                ? object.public_dependency.map(function (e) { return Number(e); })
                : [],
            weak_dependency: Array.isArray(object === null || object === void 0 ? void 0 : object.weak_dependency) ? object.weak_dependency.map(function (e) { return Number(e); }) : [],
            message_type: Array.isArray(object === null || object === void 0 ? void 0 : object.message_type)
                ? object.message_type.map(function (e) { return exports.DescriptorProto.fromJSON(e); })
                : [],
            enum_type: Array.isArray(object === null || object === void 0 ? void 0 : object.enum_type)
                ? object.enum_type.map(function (e) { return exports.EnumDescriptorProto.fromJSON(e); })
                : [],
    ...
    toJSON: function (message) {
        ...
        if (message.public_dependency) {
            obj.public_dependency = message.public_dependency.map(function (e) { return Math.round(e); });
        }
        else {
            obj.public_dependency = [];
        }
        if (message.weak_dependency) {
            obj.weak_dependency = message.weak_dependency.map(function (e) { return Math.round(e); });
        }
        else {
            obj.weak_dependency = [];
        }
        if (message.message_type) {
            obj.message_type = message.message_type.map(function (e) { return e ? exports.DescriptorProto.toJSON(e) : undefined; });
        }
        else {
            obj.message_type = [];
        }
        if (message.enum_type) {
            obj.enum_type = message.enum_type.map(function (e) { return e ? exports.EnumDescriptorProto.toJSON(e) : undefined; });
        }
        else {
            obj.enum_type = [];
        }
        ...
        message.source_code_info !== undefined &&
            (obj.source_code_info = message.source_code_info ? exports.SourceCodeInfo.toJSON(message.source_code_info) : undefined);
    ...
    fromPartial: function (object) {
        ...
        message.public_dependency = ((_d = object.public_dependency) === null || _d === void 0 ? void 0 : _d.map(function (e) { return e; })) || [];
        message.weak_dependency = ((_e = object.weak_dependency) === null || _e === void 0 ? void 0 : _e.map(function (e) { return e; })) || [];
        message.message_type = ((_f = object.message_type) === null || _f === void 0 ? void 0 : _f.map(function (e) { return exports.DescriptorProto.fromPartial(e); })) || [];
        message.enum_type = ((_g = object.enum_type) === null || _g === void 0 ? void 0 : _g.map(function (e) { return exports.EnumDescriptorProto.fromPartial(e); })) || [];
...
exports.DescriptorProto = {
    encode: function (message, writer) {
        ...
        for (var _d = 0, _e = message.nested_type; _d < _e.length; _d++) {
            var v = _e[_d];
            exports.DescriptorProto.encode(v, writer.uint32(26).fork()).ldelim();
        }
        for (var _f = 0, _g = message.enum_type; _f < _g.length; _f++) {
            var v = _g[_f];
            exports.EnumDescriptorProto.encode(v, writer.uint32(34).fork()).ldelim();
        }
        for (var _h = 0, _j = message.extension_range; _h < _j.length; _h++) {
            var v = _j[_h];
            exports.DescriptorProto_ExtensionRange.encode(v, writer.uint32(42).fork()).ldelim();
        }
        for (var _k = 0, _l = message.oneof_decl; _k < _l.length; _k++) {
            var v = _l[_k];
        ...
        for (var _m = 0, _o = message.reserved_range; _m < _o.length; _m++) {
            var v = _o[_m];
            exports.DescriptorProto_ReservedRange.encode(v, writer.uint32(74).fork()).ldelim();
        }
        for (var _p = 0, _q = message.reserved_name; _p < _q.length; _p++) {
            var v = _q[_p];
    ...
    fromJSON: function (object) {
        return {
            ...
            nested_type: Array.isArray(object === null || object === void 0 ? void 0 : object.nested_type)
                ? object.nested_type.map(function (e) { return exports.DescriptorProto.fromJSON(e); })
                : [],
            enum_type: Array.isArray(object === null || object === void 0 ? void 0 : object.enum_type)
                ? object.enum_type.map(function (e) { return exports.EnumDescriptorProto.fromJSON(e); })
                : [],
            extension_range: Array.isArray(object === null || object === void 0 ? void 0 : object.extension_range)
                ? object.extension_range.map(function (e) { return exports.DescriptorProto_ExtensionRange.fromJSON(e); })
                : [],
            oneof_decl: Array.isArray(object === null || object === void 0 ? void 0 : object.oneof_decl)
                ? object.oneof_decl.map(function (e) { return exports.OneofDescriptorProto.fromJSON(e); })
                : [],
            ...
            reserved_range: Array.isArray(object === null || object === void 0 ? void 0 : object.reserved_range)
                ? object.reserved_range.map(function (e) { return exports.DescriptorProto_ReservedRange.fromJSON(e); })
                : [],
            reserved_name: Array.isArray(object === null || object === void 0 ? void 0 : object.reserved_name)
                ? object.reserved_name.map(function (e) { return String(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.nested_type) {
            obj.nested_type = message.nested_type.map(function (e) { return e ? exports.DescriptorProto.toJSON(e) : undefined; });
        }
        else {
            obj.nested_type = [];
        }
        ...
        if (message.oneof_decl) {
            obj.oneof_decl = message.oneof_decl.map(function (e) { return e ? exports.OneofDescriptorProto.toJSON(e) : undefined; });
        }
        else {
            obj.oneof_decl = [];
        }
        ...
        if (message.reserved_range) {
            obj.reserved_range = message.reserved_range.map(function (e) { return e ? exports.DescriptorProto_ReservedRange.toJSON(e) : undefined; });
        }
        else {
            obj.reserved_range = [];
        }
        if (message.reserved_name) {
            obj.reserved_name = message.reserved_name.map(function (e) { return e; });
        }
        else {
            obj.reserved_name = [];
        }
    ...
    fromPartial: function (object) {
        ...
        message.nested_type = ((_d = object.nested_type) === null || _d === void 0 ? void 0 : _d.map(function (e) { return exports.DescriptorProto.fromPartial(e); })) || [];
        message.enum_type = ((_e = object.enum_type) === null || _e === void 0 ? void 0 : _e.map(function (e) { return exports.EnumDescriptorProto.fromPartial(e); })) || [];
        message.extension_range = ((_f = object.extension_range) === null || _f === void 0 ? void 0 : _f.map(function (e) { return exports.DescriptorProto_ExtensionRange.fromPartial(e); })) || [];
        message.oneof_decl = ((_g = object.oneof_decl) === null || _g === void 0 ? void 0 : _g.map(function (e) { return exports.OneofDescriptorProto.fromPartial(e); })) || [];
        message.options = (object.options !== undefined && object.options !== null)
            ? exports.MessageOptions.fromPartial(object.options)
            : undefined;
        message.reserved_range = ((_h = object.reserved_range) === null || _h === void 0 ? void 0 : _h.map(function (e) { return exports.DescriptorProto_ReservedRange.fromPartial(e); })) || [];
        message.reserved_name = ((_j = object.reserved_name) === null || _j === void 0 ? void 0 : _j.map(function (e) { return e; })) || [];
        return message;
    },
};
...
exports.ExtensionRangeOptions = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        for (var _i = 0, _a = message.uninterpreted_option; _i < _a.length; _i++) {
            var v = _a[_i];
    ...
    fromJSON: function (object) {
        return {
            uninterpreted_option: Array.isArray(object === null || object === void 0 ? void 0 : object.uninterpreted_option)
                ? object.uninterpreted_option.map(function (e) { return exports.UninterpretedOption.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.uninterpreted_option) {
            obj.uninterpreted_option = message.uninterpreted_option.map(function (e) { return e ? exports.UninterpretedOption.toJSON(e) : undefined; });
        }
        else {
    ...
    fromPartial: function (object) {
        var _a;
        var message = createBaseExtensionRangeOptions();
        message.uninterpreted_option = ((_a = object.uninterpreted_option) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.UninterpretedOption.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.EnumDescriptorProto = {
    encode: function (message, writer) {
        ...
        for (var _b = 0, _c = message.reserved_range; _b < _c.length; _b++) {
            var v = _c[_b];
            exports.EnumDescriptorProto_EnumReservedRange.encode(v, writer.uint32(34).fork()).ldelim();
        }
        for (var _d = 0, _e = message.reserved_name; _d < _e.length; _d++) {
            var v = _e[_d];
    ...
    fromJSON: function (object) {
        return {
            ...
            reserved_range: Array.isArray(object === null || object === void 0 ? void 0 : object.reserved_range)
                ? object.reserved_range.map(function (e) { return exports.EnumDescriptorProto_EnumReservedRange.fromJSON(e); })
                : [],
            reserved_name: Array.isArray(object === null || object === void 0 ? void 0 : object.reserved_name) ? object.reserved_name.map(function (e) { return String(e); }) : [],
        };
    },
    toJSON: function (message) {
        var obj = {};
    ...
    fromPartial: function (object) {
        ...
        message.options = (object.options !== undefined && object.options !== null)
            ...
            : undefined;
        message.reserved_range = ((_c = object.reserved_range) === null || _c === void 0 ? void 0 : _c.map(function (e) { return exports.EnumDescriptorProto_EnumReservedRange.fromPartial(e); })) ||
            [];
        message.reserved_name = ((_d = object.reserved_name) === null || _d === void 0 ? void 0 : _d.map(function (e) { return e; })) || [];
        return message;
    },
};
...
exports.FileOptions = {
    ...
    fromPartial: function (object) {
        ...
        message.optimize_for = (_f = object.optimize_for) !== null && _f !== void 0 ? _f : FileOptions_OptimizeMode.SPEED;
        ...
        message.uninterpreted_option = ((_w = object.uninterpreted_option) === null || _w === void 0 ? void 0 : _w.map(function (e) { return exports.UninterpretedOption.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.MessageOptions = {
    ...
    fromPartial: function (object) {
        ...
        message.uninterpreted_option = ((_e = object.uninterpreted_option) === null || _e === void 0 ? void 0 : _e.map(function (e) { return exports.UninterpretedOption.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.FieldOptions = {
    ...
    fromPartial: function (object) {
        ...
        message.uninterpreted_option = ((_g = object.uninterpreted_option) === null || _g === void 0 ? void 0 : _g.map(function (e) { return exports.UninterpretedOption.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.EnumOptions = {
    ...
    fromPartial: function (object) {
        ...
        message.uninterpreted_option = ((_c = object.uninterpreted_option) === null || _c === void 0 ? void 0 : _c.map(function (e) { return exports.UninterpretedOption.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.EnumValueOptions = {
    ...
    fromPartial: function (object) {
        ...
        message.uninterpreted_option = ((_b = object.uninterpreted_option) === null || _b === void 0 ? void 0 : _b.map(function (e) { return exports.UninterpretedOption.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.MethodOptions = {
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseMethodOptions();
        message.deprecated = (_a = object.deprecated) !== null && _a !== void 0 ? _a : false;
        message.idempotency_level = (_b = object.idempotency_level) !== null && _b !== void 0 ? _b : MethodOptions_IdempotencyLevel.IDEMPOTENCY_UNKNOWN;
        message.uninterpreted_option = ((_c = object.uninterpreted_option) === null || _c === void 0 ? void 0 : _c.map(function (e) { return exports.UninterpretedOption.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.UninterpretedOption = {
    ...
    toJSON: function (message) {
        ...
        message.string_value !== undefined &&
            (obj.string_value = base64FromBytes(message.string_value !== undefined ? message.string_value : new Uint8Array()));
...
exports.SourceCodeInfo_Location = {
    encode: function (message, writer) {
        ...
        for (var _d = 0, _e = message.leading_detached_comments; _d < _e.length; _d++) {
            var v = _e[_d];
    ...
    fromJSON: function (object) {
        return {
            ...
            leading_detached_comments: Array.isArray(object === null || object === void 0 ? void 0 : object.leading_detached_comments)
                ? object.leading_detached_comments.map(function (e) { return String(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if (message.leading_detached_comments) {
            obj.leading_detached_comments = message.leading_detached_comments.map(function (e) { return e; });
        }
        else {
    ...
    fromPartial: function (object) {
        ...
        message.leading_detached_comments = ((_e = object.leading_detached_comments) === null || _e === void 0 ? void 0 : _e.map(function (e) { return e; })) || [];
        return message;
    },
};

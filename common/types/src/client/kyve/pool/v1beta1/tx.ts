...
export const MsgCreatePoolResponse: MessageFns<MsgCreatePoolResponse> = {
  encode(_: MsgCreatePoolResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgUpdatePool: MessageFns<MsgUpdatePool> = {
  encode(message: MsgUpdatePool, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
    if (message.id !== "0") {
...
export const MsgUpdatePoolResponse: MessageFns<MsgUpdatePoolResponse> = {
  encode(_: MsgUpdatePoolResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const MsgDisablePool: MessageFns<MsgDisablePool> = {
  encode(message: MsgDisablePool, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
    if (message.id !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgDisablePool {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgDisablePoolResponse: MessageFns<MsgDisablePoolResponse> = {
  encode(_: MsgDisablePoolResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgDisablePoolResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgEnablePool: MessageFns<MsgEnablePool> = {
  encode(message: MsgEnablePool, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
    if (message.id !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgEnablePool {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgEnablePoolResponse: MessageFns<MsgEnablePoolResponse> = {
  encode(_: MsgEnablePoolResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgEnablePoolResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgScheduleRuntimeUpgrade: MessageFns<MsgScheduleRuntimeUpgrade> = {
  encode(message: MsgScheduleRuntimeUpgrade, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
    if (message.runtime !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgScheduleRuntimeUpgrade {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgScheduleRuntimeUpgradeResponse: MessageFns<MsgScheduleRuntimeUpgradeResponse> = {
  encode(_: MsgScheduleRuntimeUpgradeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgScheduleRuntimeUpgradeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgCancelRuntimeUpgrade: MessageFns<MsgCancelRuntimeUpgrade> = {
  encode(message: MsgCancelRuntimeUpgrade, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authority !== "") {
      writer.uint32(10).string(message.authority);
    }
    if (message.runtime !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgCancelRuntimeUpgrade {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgCancelRuntimeUpgradeResponse: MessageFns<MsgCancelRuntimeUpgradeResponse> = {
  encode(_: MsgCancelRuntimeUpgradeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MsgCancelRuntimeUpgradeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;

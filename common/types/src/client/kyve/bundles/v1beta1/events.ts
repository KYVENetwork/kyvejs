...
export interface EventBundleFinalized {
  ...
  reward_uploader_storage_cost: Coin[];
}
...
export const EventBundleFinalized = {
  encode(message: EventBundleFinalized, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.funders_payout) {
      Coin.encode(v!, writer.uint32(66).fork()).ldelim();
    }
    if (message.inflation_payout !== "0") {
      writer.uint32(72).uint64(message.inflation_payout);
    }
    for (const v of message.reward_treasury) {
      Coin.encode(v!, writer.uint32(82).fork()).ldelim();
    }
    for (const v of message.reward_uploader_commission) {
      Coin.encode(v!, writer.uint32(90).fork()).ldelim();
    }
    for (const v of message.reward_delegation) {
      Coin.encode(v!, writer.uint32(98).fork()).ldelim();
    }
    for (const v of message.reward_total) {
    ...
    for (const v of message.reward_uploader_storage_cost) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.funders_payout.push(Coin.decode(reader, reader.uint32()));
          continue;
        case 9:
          if (tag !== 72) {
            break;
        ...
        case 10:
          ...
          message.reward_treasury.push(Coin.decode(reader, reader.uint32()));
          continue;
        case 11:
          if (tag !== 90) {
            break;
          ...
          message.reward_uploader_commission.push(Coin.decode(reader, reader.uint32()));
          continue;
        case 12:
          if (tag !== 98) {
            break;
          ...
          message.reward_delegation.push(Coin.decode(reader, reader.uint32()));
          continue;
        case 13:
          if (tag !== 106) {
            break;
          ...
          message.reward_total.push(Coin.decode(reader, reader.uint32()));
          continue;
        case 14:
          if (tag !== 112) {
            break;
        ...
        case 17:
          ...
          message.reward_uploader_storage_cost.push(Coin.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): EventBundleFinalized {
    return {
      ...
      funders_payout: globalThis.Array.isArray(object?.funders_payout)
        ? object.funders_payout.map((e: any) => Coin.fromJSON(e))
        : [],
      inflation_payout: isSet(object.inflation_payout) ? globalThis.String(object.inflation_payout) : "0",
      reward_treasury: globalThis.Array.isArray(object?.reward_treasury)
        ? object.reward_treasury.map((e: any) => Coin.fromJSON(e))
        : [],
      reward_uploader_commission: globalThis.Array.isArray(object?.reward_uploader_commission)
        ? object.reward_uploader_commission.map((e: any) => Coin.fromJSON(e))
        : [],
      reward_delegation: globalThis.Array.isArray(object?.reward_delegation)
        ? object.reward_delegation.map((e: any) => Coin.fromJSON(e))
        : [],
      reward_total: globalThis.Array.isArray(object?.reward_total)
        ? object.reward_total.map((e: any) => Coin.fromJSON(e))
        : [],
      ...
      reward_uploader_storage_cost: globalThis.Array.isArray(object?.reward_uploader_storage_cost)
        ? object.reward_uploader_storage_cost.map((e: any) => Coin.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: EventBundleFinalized): unknown {
    ...
    if (message.funders_payout?.length) {
      obj.funders_payout = message.funders_payout.map((e) => Coin.toJSON(e));
    }
    if (message.inflation_payout !== "0") {
      obj.inflation_payout = message.inflation_payout;
    }
    if (message.reward_treasury?.length) {
      obj.reward_treasury = message.reward_treasury.map((e) => Coin.toJSON(e));
    }
    if (message.reward_uploader_commission?.length) {
      obj.reward_uploader_commission = message.reward_uploader_commission.map((e) => Coin.toJSON(e));
    }
    if (message.reward_delegation?.length) {
      obj.reward_delegation = message.reward_delegation.map((e) => Coin.toJSON(e));
    }
    if (message.reward_total?.length) {
      obj.reward_total = message.reward_total.map((e) => Coin.toJSON(e));
    }
    if (message.finalized_at !== "0") {
    ...
    if (message.reward_uploader_storage_cost?.length) {
      obj.reward_uploader_storage_cost = message.reward_uploader_storage_cost.map((e) => Coin.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<EventBundleFinalized>, I>>(object: I): EventBundleFinalized {
    ...
    message.funders_payout = object.funders_payout?.map((e) => Coin.fromPartial(e)) || [];
    message.inflation_payout = object.inflation_payout ?? "0";
    message.reward_treasury = object.reward_treasury?.map((e) => Coin.fromPartial(e)) || [];
    message.reward_uploader_commission = object.reward_uploader_commission?.map((e) => Coin.fromPartial(e)) || [];
    message.reward_delegation = object.reward_delegation?.map((e) => Coin.fromPartial(e)) || [];
    message.reward_total = object.reward_total?.map((e) => Coin.fromPartial(e)) || [];
    message.finalized_at = object.finalized_at ?? "0";
    message.uploader = object.uploader ?? "";
    message.next_uploader = object.next_uploader ?? "";
    message.reward_uploader_storage_cost = object.reward_uploader_storage_cost?.map((e) => Coin.fromPartial(e)) || [];
    return message;
  },
};

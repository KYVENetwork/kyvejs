...
function createBaseQueryAccountAssetsResponse(): QueryAccountAssetsResponse {
  return { balance: "0", delegation: "0", delegation_unbonding: "0", outstanding_rewards: [], protocol_funding: [] };
}
...
export const QueryAccountAssetsResponse: MessageFns<QueryAccountAssetsResponse> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.outstanding_rewards.push(Coin.decode(reader, reader.uint32()));
          continue;
        }
        case 7: {
          if (tag !== 58) {
  ...
  fromJSON(object: any): QueryAccountAssetsResponse {
    return {
      ...
      outstanding_rewards: globalThis.Array.isArray(object?.outstanding_rewards)
        ? object.outstanding_rewards.map((e: any) => Coin.fromJSON(e))
        : [],
  ...
  toJSON(message: QueryAccountAssetsResponse): unknown {
    ...
    if (message.outstanding_rewards?.length) {
      obj.outstanding_rewards = message.outstanding_rewards.map((e) => Coin.toJSON(e));
    }
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAccountAssetsResponse>, I>>(object: I): QueryAccountAssetsResponse {
    ...
    message.outstanding_rewards = object.outstanding_rewards?.map((e) => Coin.fromPartial(e)) || [];

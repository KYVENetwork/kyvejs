    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12: {
          ...
          message.storage_provider_id = reader.uint64().toString();
          continue;
        }
        case 13: {
          if (tag !== 104) {
          ...
          message.compression_id = reader.uint64().toString();
          continue;
        }
        case 14: {
          if (tag !== 114) {
...
export const QueryFinalizedBundlesRequest: MessageFns<QueryFinalizedBundlesRequest> = {
  encode(message: QueryFinalizedBundlesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFinalizedBundlesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFinalizedBundlesResponse: MessageFns<QueryFinalizedBundlesResponse> = {
  encode(message: QueryFinalizedBundlesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.finalized_bundles) {
      FinalizedBundle.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFinalizedBundlesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFinalizedBundleRequest: MessageFns<QueryFinalizedBundleRequest> = {
  encode(message: QueryFinalizedBundleRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pool_id !== "0") {
      writer.uint32(8).uint64(message.pool_id);
    }
    if (message.id !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFinalizedBundleRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFinalizedBundleResponse: MessageFns<QueryFinalizedBundleResponse> = {
  encode(message: QueryFinalizedBundleResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pool_id !== "0") {
      writer.uint32(8).uint64(message.pool_id);
    }
    if (message.id !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFinalizedBundleResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryCurrentVoteStatusRequest: MessageFns<QueryCurrentVoteStatusRequest> = {
  encode(message: QueryCurrentVoteStatusRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pool_id !== "0") {
      writer.uint32(8).uint64(message.pool_id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCurrentVoteStatusRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryCurrentVoteStatusResponse: MessageFns<QueryCurrentVoteStatusResponse> = {
  encode(message: QueryCurrentVoteStatusResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.valid !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCurrentVoteStatusResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseQueryCanValidateRequest(): QueryCanValidateRequest {
  return { pool_id: "0", pool_address: "" };
}

export const QueryCanValidateRequest: MessageFns<QueryCanValidateRequest> = {
  encode(message: QueryCanValidateRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pool_id !== "0") {
      writer.uint32(8).uint64(message.pool_id);
    }
    if (message.pool_address !== "") {
      writer.uint32(18).string(message.pool_address);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryCanValidateRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryCanValidateResponse: MessageFns<QueryCanValidateResponse> = {
  encode(message: QueryCanValidateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCanValidateResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryCanProposeRequest: MessageFns<QueryCanProposeRequest> = {
  encode(message: QueryCanProposeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pool_id !== "0") {
      writer.uint32(8).uint64(message.pool_id);
    }
    if (message.staker !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCanProposeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryCanProposeResponse: MessageFns<QueryCanProposeResponse> = {
  encode(message: QueryCanProposeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.possible !== false) {
      writer.uint32(8).bool(message.possible);
    }
    if (message.reason !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCanProposeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryCanVoteRequest: MessageFns<QueryCanVoteRequest> = {
  encode(message: QueryCanVoteRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pool_id !== "0") {
      writer.uint32(8).uint64(message.pool_id);
    }
    if (message.staker !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCanVoteRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryCanVoteResponse: MessageFns<QueryCanVoteResponse> = {
  encode(message: QueryCanVoteResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.possible !== false) {
      writer.uint32(8).bool(message.possible);
    }
    if (message.reason !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryCanVoteResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class QueryBundlesClientImpl implements QueryBundles {
  ...
  FinalizedBundlesQuery(request: QueryFinalizedBundlesRequest): Promise<QueryFinalizedBundlesResponse> {
    ...
    return promise.then((data) => QueryFinalizedBundlesResponse.decode(new BinaryReader(data)));
  }
  ...
  FinalizedBundleQuery(request: QueryFinalizedBundleRequest): Promise<QueryFinalizedBundleResponse> {
    ...
    return promise.then((data) => QueryFinalizedBundleResponse.decode(new BinaryReader(data)));
  }

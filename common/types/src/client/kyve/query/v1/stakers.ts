...
export const QueryStakersRequest: MessageFns<QueryStakersRequest> = {
  encode(message: QueryStakersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryStakersRequest {
...
export const QueryStakersResponse: MessageFns<QueryStakersResponse> = {
  encode(message: QueryStakersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.stakers) {
      FullStaker.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryStakersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryStakerRequest: MessageFns<QueryStakerRequest> = {
  encode(message: QueryStakerRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryStakerRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryStakerResponse: MessageFns<QueryStakerResponse> = {
  encode(message: QueryStakerResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.staker !== undefined) {
      FullStaker.encode(message.staker, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryStakerResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryStakersByPoolRequest: MessageFns<QueryStakersByPoolRequest> = {
  encode(message: QueryStakersByPoolRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryStakersByPoolRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryStakersByPoolResponse: MessageFns<QueryStakersByPoolResponse> = {
  encode(message: QueryStakersByPoolResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.stakers) {
      FullStaker.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryStakersByPoolResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryStakersByPoolCountRequest: MessageFns<QueryStakersByPoolCountRequest> = {
  encode(message: QueryStakersByPoolCountRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryStakersByPoolCountRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryStakersByPoolCountResponse: MessageFns<QueryStakersByPoolCountResponse> = {
  encode(message: QueryStakersByPoolCountResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.stakers) {
      FullStaker.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryStakersByPoolCountResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class QueryStakersClientImpl implements QueryStakers {
  ...
  Stakers(request: QueryStakersRequest): Promise<QueryStakersResponse> {
    ...
    return promise.then((data) => QueryStakersResponse.decode(new BinaryReader(data)));
  }

  Staker(request: QueryStakerRequest): Promise<QueryStakerResponse> {
    const data = QueryStakerRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "Staker", data);
    return promise.then((data) => QueryStakerResponse.decode(new BinaryReader(data)));
  }

  StakersByPool(request: QueryStakersByPoolRequest): Promise<QueryStakersByPoolResponse> {
    const data = QueryStakersByPoolRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "StakersByPool", data);
    return promise.then((data) => QueryStakersByPoolResponse.decode(new BinaryReader(data)));
  }
  ...
  StakersByPoolCount(request: QueryStakersByPoolCountRequest): Promise<QueryStakersByPoolCountResponse> {
    ...
    return promise.then((data) => QueryStakersByPoolCountResponse.decode(new BinaryReader(data)));
  }
}

    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.unbonding_delegation_time = reader.uint64().toString();
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.redelegation_cooldown = reader.uint64().toString();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.redelegation_max_amount = reader.uint64().toString();
          continue;
        }
        case 4: {
          if (tag !== 34) {

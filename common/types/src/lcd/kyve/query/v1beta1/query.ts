...
function createBaseFullStaker(): FullStaker {
  return { address: "", validator: undefined, total_pool_stake: "0", pools: [] };
}
...
export const FullStaker: MessageFns<FullStaker> = {
  encode(message: FullStaker, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.total_pool_stake !== "0") {
      writer.uint32(24).uint64(message.total_pool_stake);
    }
    for (const v of message.pools) {
      PoolMembership.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.total_pool_stake = reader.uint64().toString();
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): FullStaker {
    return {
      ...
      total_pool_stake: isSet(object.total_pool_stake) ? globalThis.String(object.total_pool_stake) : "0",
  ...
  toJSON(message: FullStaker): unknown {
    ...
    if (message.total_pool_stake !== "0") {
      obj.total_pool_stake = message.total_pool_stake;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<FullStaker>, I>>(object: I): FullStaker {
    ...
    message.validator = (object.validator !== undefined && object.validator !== null)
      ...
      : undefined;
    message.total_pool_stake = object.total_pool_stake ?? "0";

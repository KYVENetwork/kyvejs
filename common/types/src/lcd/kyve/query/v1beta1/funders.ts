...
export const Funder: MessageFns<Funder> = {
  encode(message: Funder, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stats !== undefined) {
      FundingStats.encode(message.stats, writer.uint32(58).fork()).join();
    }
    return writer;
  },
...
export const FundingStats: MessageFns<FundingStats> = {
  encode(message: FundingStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FundingStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          if (tag === 32) {
            message.pools_funded.push(reader.uint64().toString());
...
export const QueryFundersRequest: MessageFns<QueryFundersRequest> = {
  encode(message: QueryFundersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFundersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFundersResponse: MessageFns<QueryFundersResponse> = {
  encode(message: QueryFundersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFundersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFunderRequest: MessageFns<QueryFunderRequest> = {
  encode(message: QueryFunderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFunderRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFunderResponse: MessageFns<QueryFunderResponse> = {
  encode(message: QueryFunderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.funder !== undefined) {
      Funder.encode(message.funder, writer.uint32(10).fork()).join();
    }
    for (const v of message.fundings) {
      Funding.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryFunderResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFundingsByFunderRequest: MessageFns<QueryFundingsByFunderRequest> = {
  encode(message: QueryFundingsByFunderRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    if (message.address !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFundingsByFunderRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFundingsByFunderResponse: MessageFns<QueryFundingsByFunderResponse> = {
  encode(message: QueryFundingsByFunderResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    for (const v of message.fundings) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFundingsByFunderResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFundingsByPoolRequest: MessageFns<QueryFundingsByPoolRequest> = {
  encode(message: QueryFundingsByPoolRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    if (message.pool_id !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFundingsByPoolRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryFundingsByPoolResponse: MessageFns<QueryFundingsByPoolResponse> = {
  encode(message: QueryFundingsByPoolResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pagination !== undefined) {
      PageResponse.encode(message.pagination, writer.uint32(10).fork()).join();
    }
    for (const v of message.fundings) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryFundingsByPoolResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class QueryFundersClientImpl implements QueryFunders {
  ...
  Funders(request: QueryFundersRequest): Promise<QueryFundersResponse> {
    ...
    return promise.then((data) => QueryFundersResponse.decode(new BinaryReader(data)));
  }

  Funder(request: QueryFunderRequest): Promise<QueryFunderResponse> {
    const data = QueryFunderRequest.encode(request).finish();
    const promise = this.rpc.request(this.service, "Funder", data);
    return promise.then((data) => QueryFunderResponse.decode(new BinaryReader(data)));
  }
  ...
  FundingsByFunder(request: QueryFundingsByFunderRequest): Promise<QueryFundingsByFunderResponse> {
    ...
    return promise.then((data) => QueryFundingsByFunderResponse.decode(new BinaryReader(data)));
  }
  ...
  FundingsByPool(request: QueryFundingsByPoolRequest): Promise<QueryFundingsByPoolResponse> {
    ...
    return promise.then((data) => QueryFundingsByPoolResponse.decode(new BinaryReader(data)));
  }
}

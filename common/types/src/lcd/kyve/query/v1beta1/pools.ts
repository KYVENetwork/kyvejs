...
export const QueryPoolsResponse: MessageFns<QueryPoolsResponse> = {
  encode(message: QueryPoolsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.pools) {
      PoolResponse.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.pagination !== undefined) {
...
export const PoolResponse: MessageFns<PoolResponse> = {
  encode(message: PoolResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.data !== undefined) {
      Pool.encode(message.data, writer.uint32(18).fork()).join();
    }
    if (message.bundle_proposal !== undefined) {
      BundleProposal.encode(message.bundle_proposal, writer.uint32(26).fork()).join();
    }
    ...
    for (const v of message.fundings) {
      Funding.encode(v!, writer.uint32(82).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.total_self_delegation = reader.uint64().toString();
          continue;
        }
        case 6: {
          if (tag !== 48) {
        ...
        case 9: {
          ...
          message.account_balance = reader.uint64().toString();
          continue;
        }
        case 10: {
          if (tag !== 82) {
...
export const QueryPoolResponse: MessageFns<QueryPoolResponse> = {
  encode(message: QueryPoolResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.pool !== undefined) {
      PoolResponse.encode(message.pool, writer.uint32(10).fork()).join();
    }
    return writer;
  },

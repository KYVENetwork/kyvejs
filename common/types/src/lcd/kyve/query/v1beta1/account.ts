...
export const QueryAccountAssetsResponse = {
  encode(message: QueryAccountAssetsResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.protocol_rewards) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.protocol_rewards.push(Coin.decode(reader, reader.uint32()));
          continue;
        case 7:
          if (tag !== 58) {
            break;
  ...
  fromJSON(object: any): QueryAccountAssetsResponse {
    return {
      ...
      protocol_delegation_unbonding: isSet(object.protocol_delegation_unbonding)
        ...
        : "0",
      protocol_rewards: globalThis.Array.isArray(object?.protocol_rewards)
        ? object.protocol_rewards.map((e: any) => Coin.fromJSON(e))
        : [],
  ...
  toJSON(message: QueryAccountAssetsResponse): unknown {
    ...
    if (message.protocol_rewards?.length) {
      obj.protocol_rewards = message.protocol_rewards.map((e) => Coin.toJSON(e));
    }
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAccountAssetsResponse>, I>>(object: I): QueryAccountAssetsResponse {
    ...
    message.protocol_rewards = object.protocol_rewards?.map((e) => Coin.fromPartial(e)) || [];

...
export const QueryTeamInfoRequest: MessageFns<QueryTeamInfoRequest> = {
  encode(_: QueryTeamInfoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryTeamInfoRequest {
...
export const QueryTeamInfoResponse: MessageFns<QueryTeamInfoResponse> = {
  encode(message: QueryTeamInfoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTeamInfoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.total_team_allocation = reader.uint64().toString();
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.issued_team_allocation = reader.uint64().toString();
          continue;
        }
        case 5: {
          if (tag !== 40) {
          ...
          message.available_team_allocation = reader.uint64().toString();
          continue;
        }
        case 6: {
          if (tag !== 48) {
          ...
          message.total_authority_rewards = reader.uint64().toString();
          continue;
        }
        case 7: {
          if (tag !== 56) {
          ...
          message.claimed_authority_rewards = reader.uint64().toString();
          continue;
        }
        case 8: {
          if (tag !== 64) {
          ...
          message.available_authority_rewards = reader.uint64().toString();
          continue;
        }
        case 9: {
          if (tag !== 72) {
          ...
          message.total_account_rewards = reader.uint64().toString();
          continue;
        }
        case 10: {
          if (tag !== 80) {
          ...
          message.claimed_account_rewards = reader.uint64().toString();
          continue;
        }
        case 11: {
          if (tag !== 88) {
          ...
          message.available_account_rewards = reader.uint64().toString();
          continue;
        }
        case 12: {
          if (tag !== 96) {
          ...
          message.required_module_balance = reader.uint64().toString();
          continue;
        }
        case 13: {
          if (tag !== 104) {
          ...
          message.team_module_balance = reader.uint64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const QueryTeamVestingAccountsRequest: MessageFns<QueryTeamVestingAccountsRequest> = {
  encode(_: QueryTeamVestingAccountsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryTeamVestingAccountsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTeamVestingAccountsResponse: MessageFns<QueryTeamVestingAccountsResponse> = {
  encode(message: QueryTeamVestingAccountsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.accounts) {
      TeamVestingAccount.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryTeamVestingAccountsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTeamVestingAccountRequest: MessageFns<QueryTeamVestingAccountRequest> = {
  encode(message: QueryTeamVestingAccountRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTeamVestingAccountRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTeamVestingAccountResponse: MessageFns<QueryTeamVestingAccountResponse> = {
  encode(message: QueryTeamVestingAccountResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.account !== undefined) {
      TeamVestingAccount.encode(message.account, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryTeamVestingAccountResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTeamVestingStatusRequest: MessageFns<QueryTeamVestingStatusRequest> = {
  encode(message: QueryTeamVestingStatusRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "0") {
      writer.uint32(8).uint64(message.id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTeamVestingStatusRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTeamVestingStatusResponse: MessageFns<QueryTeamVestingStatusResponse> = {
  encode(message: QueryTeamVestingStatusResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.request_date !== "") {
      writer.uint32(10).string(message.request_date);
    }
    if (message.plan !== undefined) {
      QueryVestingPlan.encode(message.plan, writer.uint32(18).fork()).join();
    }
    if (message.status !== undefined) {
      QueryVestingStatus.encode(message.status, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QueryTeamVestingStatusResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTeamVestingStatusByTimeRequest: MessageFns<QueryTeamVestingStatusByTimeRequest> = {
  encode(message: QueryTeamVestingStatusByTimeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "0") {
      writer.uint32(8).uint64(message.id);
    }
    if (message.time !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTeamVestingStatusByTimeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryTeamVestingStatusByTimeResponse: MessageFns<QueryTeamVestingStatusByTimeResponse> = {
  encode(message: QueryTeamVestingStatusByTimeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.request_date !== "") {
      writer.uint32(10).string(message.request_date);
    }
    if (message.plan !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryTeamVestingStatusByTimeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryVestingStatus: MessageFns<QueryVestingStatus> = {
  encode(message: QueryVestingStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryVestingStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.total_vested_amount = reader.uint64().toString();
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.total_unlocked_amount = reader.uint64().toString();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.current_claimable_amount = reader.uint64().toString();
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.locked_vested_amount = reader.uint64().toString();
          continue;
        }
        case 5: {
          if (tag !== 40) {
          ...
          message.remaining_unvested_amount = reader.uint64().toString();
          continue;
        }
        case 6: {
          if (tag !== 48) {
          ...
          message.claimed_amount = reader.uint64().toString();
          continue;
        }
        case 7: {
          if (tag !== 56) {
        ...
        case 8: {
          ...
          message.claimed_rewards = reader.uint64().toString();
          continue;
        }
        case 9: {
          if (tag !== 72) {
          ...
          message.available_rewards = reader.uint64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const QueryVestingPlan: MessageFns<QueryVestingPlan> = {
  encode(message: QueryVestingPlan, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryVestingPlan {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.clawback_amount = reader.uint64().toString();
          continue;
        }
        case 8: {
          if (tag !== 64) {
          ...
          message.maximum_vesting_amount = reader.uint64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {

...
function createBaseWhitelistCoinEntry(): WhitelistCoinEntry {
  return { coin_denom: "", min_funding_amount: "0", min_funding_amount_per_bundle: "0", coin_weight: "" };
}
...
export const WhitelistCoinEntry = {
  encode(message: WhitelistCoinEntry, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.min_funding_amount !== "0") {
      writer.uint32(16).uint64(message.min_funding_amount);
    }
    if (message.min_funding_amount_per_bundle !== "0") {
      writer.uint32(24).uint64(message.min_funding_amount_per_bundle);
    }
    if (message.coin_weight !== "") {
      writer.uint32(34).string(message.coin_weight);
    }
    return writer;
  },

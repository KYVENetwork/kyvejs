...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      funding_list: Array.isArray(object?.funding_list) ? object.funding_list.map((e: any) => Funding.fromJSON(e)) : [],
      funding_state_list: Array.isArray(object?.funding_state_list)

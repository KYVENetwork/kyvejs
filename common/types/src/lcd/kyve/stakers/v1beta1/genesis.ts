...
export interface GenesisState {
  ...
  queue_state_state_fraction?: QueueState | undefined;
}
...
function createBaseGenesisState(): GenesisState {
  return {
    ...
    stake_fraction_change_entries: [],
    queue_state_state_fraction: undefined,
  };
}
...
export const GenesisState: MessageFns<GenesisState> = {
  encode(message: GenesisState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.queue_state_state_fraction !== undefined) {
      QueueState.encode(message.queue_state_state_fraction, writer.uint32(74).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.queue_state_state_fraction = QueueState.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      stake_fraction_change_entries: globalThis.Array.isArray(object?.stake_fraction_change_entries)
        ...
        : [],
      queue_state_state_fraction: isSet(object.queue_state_state_fraction)
        ? QueueState.fromJSON(object.queue_state_state_fraction)
        : undefined,
    };
  },
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.queue_state_state_fraction !== undefined) {
      obj.queue_state_state_fraction = QueueState.toJSON(message.queue_state_state_fraction);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.queue_state_state_fraction =
      (object.queue_state_state_fraction !== undefined && object.queue_state_state_fraction !== null)
        ? QueueState.fromPartial(object.queue_state_state_fraction)
        : undefined;
    return message;
  },
};

...
import { BlockIDFlag, blockIDFlagFromJSON, blockIDFlagToJSON, blockIDFlagToNumber } from "../types/validator";
...
export function responseVerifyVoteExtension_VerifyStatusToNumber(
  object: ResponseVerifyVoteExtension_VerifyStatus,
): number {
  switch (object) {
    case ResponseVerifyVoteExtension_VerifyStatus.UNKNOWN:
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.block_version = reader.uint64().toString();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.p2p_version = reader.uint64().toString();
          continue;
        }
        case 4: {
          if (tag !== 34) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.initial_height = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.max_tx_bytes = reader.int64().toString();
          continue;
        }
        case 2: {
          if (tag !== 18) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.app_version = reader.uint64().toString();
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.last_block_height = reader.int64().toString();
          continue;
        }
        case 5: {
          if (tag !== 42) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.gas_wanted = reader.int64().toString();
          continue;
        }
        case 6: {
          if (tag !== 48) {
          ...
          message.gas_used = reader.int64().toString();
          continue;
        }
        case 7: {
          if (tag !== 58) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 3: {
          ...
          message.retain_height = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
function createBaseResponseVerifyVoteExtension(): ResponseVerifyVoteExtension {
  return { status: ResponseVerifyVoteExtension_VerifyStatus.UNKNOWN };
}
...
export const ResponseVerifyVoteExtension: MessageFns<ResponseVerifyVoteExtension> = {
  encode(message: ResponseVerifyVoteExtension, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.status !== ResponseVerifyVoteExtension_VerifyStatus.UNKNOWN) {
      writer.uint32(8).int32(responseVerifyVoteExtension_VerifyStatusToNumber(message.status));
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.status = responseVerifyVoteExtension_VerifyStatusFromJSON(reader.int32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ResponseVerifyVoteExtension {
    return {
      status: isSet(object.status)
        ...
        : ResponseVerifyVoteExtension_VerifyStatus.UNKNOWN,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ResponseVerifyVoteExtension>, I>>(object: I): ResponseVerifyVoteExtension {
    const message = createBaseResponseVerifyVoteExtension();
    message.status = object.status ?? ResponseVerifyVoteExtension_VerifyStatus.UNKNOWN;
    return message;
  },
};
...
function createBaseVoteInfo(): VoteInfo {
  return { validator: undefined, block_id_flag: BlockIDFlag.BLOCK_ID_FLAG_UNKNOWN };
}
...
export const VoteInfo: MessageFns<VoteInfo> = {
  encode(message: VoteInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.block_id_flag !== BlockIDFlag.BLOCK_ID_FLAG_UNKNOWN) {
      writer.uint32(24).int32(blockIDFlagToNumber(message.block_id_flag));
    }
    return writer;
  },
...
export const ExtendedVoteInfo: MessageFns<ExtendedVoteInfo> = {
  encode(message: ExtendedVoteInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.block_id_flag !== BlockIDFlag.BLOCK_ID_FLAG_UNKNOWN) {
      writer.uint32(40).int32(blockIDFlagToNumber(message.block_id_flag));
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.total_voting_power = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {

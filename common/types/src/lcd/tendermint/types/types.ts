...
import { BlockIDFlag, blockIDFlagFromJSON, blockIDFlagToJSON, blockIDFlagToNumber, ValidatorSet } from "./validator";
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.block_size = reader.int64().toString();
          continue;
        }
        case 3: {
          if (tag !== 26) {
        ...
        case 4: {
          ...
          message.num_txs = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {

...
import { SignMode, signModeFromJSON, signModeToJSON, signModeToNumber } from "../signing/v1beta1/signing";
...
function createBaseModeInfo_Single(): ModeInfo_Single {
  return { mode: SignMode.SIGN_MODE_UNSPECIFIED };
}
...
export const ModeInfo_Single = {
  ...
  fromJSON(object: any): ModeInfo_Single {
    return { mode: isSet(object.mode) ? signModeFromJSON(object.mode) : SignMode.SIGN_MODE_UNSPECIFIED };
  },
...
export const AuxSignerData = {
  encode(message: AuxSignerData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.mode !== SignMode.SIGN_MODE_UNSPECIFIED) {
      writer.uint32(24).int32(signModeToNumber(message.mode));
    }

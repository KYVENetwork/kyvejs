    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.unbonding_height = reader.int64().toString();
          continue;
        }
        case 9: {
          if (tag !== 74) {
        ...
        case 12: {
          ...
          message.unbonding_on_hold_ref_count = reader.int64().toString();
          continue;
        }
        case 13: {
          if (tag === 104) {
            message.unbonding_ids.push(reader.uint64().toString());
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.creation_height = reader.int64().toString();
          continue;
        }
        case 2: {
          if (tag !== 18) {
        ...
        case 5: {
          ...
          message.unbonding_id = reader.uint64().toString();
          continue;
        }
        case 6: {
          if (tag !== 48) {
